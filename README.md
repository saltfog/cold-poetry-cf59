...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/cold-poetry-cf59
```

A live public deployment of this template is available at [https://cold-poetry-cf59.templates.workers.dev](https://cold-poetry-cf59.templates.workers.dev)
